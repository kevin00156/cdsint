...
METHODS = [
    ...
    ("engine.codesys_managers", "POUManager", "export", "mgr:POUManager.export", export_bucket),
    ("engine.codesys_managers", "PropertyManager", "export", "mgr:PropertyManager.export", export_bucket),
    ("engine.codesys_managers", "NativeManager", "export", "mgr:NativeManager.export", export_bucket),
    ("engine.codesys_managers", "ConfigManager", "export", "mgr:ConfigManager.export", export_bucket),
