...
Everything the [README](../README.md) leaves out: how each command behaves, the
settings file, and the text formats cdsint reads and writes. An agent with the
skill installed reads [`skills/cdsint/SKILL.md`](../skills/cdsint/SKILL.md)
first; this is where it looks up a flag or a field.
...
The one-line install is in the [README](../README.md#install).
